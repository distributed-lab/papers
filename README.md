...
|---|---|---|---|
| [Wrapless: Bitcoin lending without wrapping services](https://github.com/distributed-lab/papers/tree/main/wrapless) | Bitcoin, DeFi | Preprint | Kurbatov, Oleksandr, et al. "Wrapless: Bitcoin lending without wrapping services." |
