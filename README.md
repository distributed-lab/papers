...
|---|---|---|---|
| [Understanding Lasso: A Novel Lookup Argument Protocol](https://github.com/distributed-lab/papers/blob/main/iden3/Confidential_Wrapped_Ethereum.pdf) | ZKP, Cryptography | Preprint  | Oleg Fomenko and Anton Levochko. "Understanding Lasso: A Novel Lookup Argument Protocol". Cryptology {ePrint} Archive, Paper 2025/1169 |
...
| [Confidential Wrapped Ethereum](https://github.com/distributed-lab/papers/blob/main/cWETH/Confidential_Wrapped_Ethereum.pdf) | Privacy, ZKP, finance            | -         | Chystiakov, Artem, Zhvanko Mariia. "Confidential Wrapped Ethereum" |
| [ZEX: Confidential Peer-to-Peer DEX](https://github.com/distributed-lab/papers/blob/main/cWETH/ZEX_confidential_peer_to_peer_DEX.pdf) | Privacy, ZKP, finance       | -         | Chystiakov, Artem, Zhvanko Mariia. "ZEX: Confidential Peer-to-Peer DEX v0.1" |
