...
| In Da Club | in-da-club/In_Da_Club.pdf | Identity | Pre-print | Mr. Chewbacca. "In Da Club."
| Extending the SPV contract concept with privacy gadgets | spv/Extending_the_SPV_contract_concept_with_privacy_gadgets.pdf | Bitcoin, ZKP | Pre-print | Kurbatov, Oleksandr, et al. "Extending the SPV contract concept with privacy gadgets." |
...
| ZK Multisig Wallet Proposal | zk-multisig/zk_multisig.pdf | ZKP | Pre-print | Chystiakov, Artem, et al. "ZK Multisig Wallet Proposal." |
| Freedom Tool: Passport-based Anonymous Voting Solution | freedom-tool/Freedom_Tool.pdf | Privacy, voting | Pre-print | "Freedom Tool: Passport-based Anonymous Voting Solution."  
| Bulletproofs++. Construction and Examples | bulletproofs/Review_paper_on_BP.pdf | ZKP | Pre-print | Fomenko, Oleg, et al. "Bulletproofs++. Construction and Examples." |
| BFT Paxos comparison | bft-paxos/BFT_Paxos_comparison.pdf | Consensus | Pre-print | Melnik, Illia, et al. "BFT Paxos comparison."
...
|  How to Iden3 |  iden3/How-to-Iden3.pdf |  Identity |   |   |
